...
export const InstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-80 bg-white border border-slate-200 shadow-xl rounded-lg p-4 z-50 flex items-center justify-between animate-[slide-in-from-bottom_0.5s_ease-out]">
